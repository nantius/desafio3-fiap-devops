...
USE_LOCAL_DYNAMO = os.getenv("USE_LOCAL_DYNAMO")
LOCAL_DYNAMO_URL = os.getenv("LOCAL_DYNAMO_URL")
...
try:
    ...
    if USE_LOCAL_DYNAMO:
        dynamodb_client = session.client("dynamodb", endpoint_url=LOCAL_DYNAMO_URL)
    else:
